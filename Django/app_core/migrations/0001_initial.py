# Generated by Django 4.2.3 on 2025-02-01 14:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon_point', models.IntegerField(default=0, help_text='쿠폰 포인트')),
                ('level_point', models.IntegerField(default=0, help_text='레벨업 포인트')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_type', models.CharField(help_text='게시물 타입(tree, travel, event, review, board, attendance, greeting, anominous)', max_length=20)),
                ('display_weight', models.IntegerField(default=0, help_text='표시 순서')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='normal', help_text='상태(normal, used, expired, deleted)', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_paths', models.TextField(blank=True, help_text='이미지 경로', null=True)),
                ('content', models.TextField(help_text='내용')),
                ...
                ('author', models.ForeignKey(help_text='작성자', on_delete=django.db.models.deletion.CASCADE, related_name='post_author', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point_change', models.CharField(blank=True, help_text='포인트 변동', max_length=20)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='북마크된 여행지 게시글', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='account_bookmarked_places', to='app_core.post'),
        ),
        migrations.AddField(
            model_name='account',
            name='groups',
