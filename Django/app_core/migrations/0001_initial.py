# Generated by Django 4.2.3 on 2025-01-31 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_type', models.CharField(help_text='게시물 타입(tree, travel, event, review, board, attendance, greeting)', max_length=20)),
                ('display_weight', models.IntegerField(help_text='표시 순서')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='normal', help_text='상태(normal, pending, ad, blocked)', max_length=20)),
                ('note', models.TextField(help_text='관리자 메모')),
